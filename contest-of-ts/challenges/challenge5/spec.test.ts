...
test("Challenge 5: Triangles", () => {
    ...
    expect(triangle1.getArea()).toBe(200)
    ...
    expect(triangle2.getArea()).toBe(450)
    ...
    expect(triangle3.getArea()).toBe(300)
